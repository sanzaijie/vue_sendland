        ...
        <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
            <el-tab-pane label="客户资料" name="first">
                <el-collapse accordion v-model="activeName">
                    <el-collapse-item title="客户核心信息" name="1">
                ...
                <el-collapse accordion @change="getjiben">
                    <el-collapse-item title="联系人">
                        <el-col class="toolbar">
                    ...
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-select v-model="filters.fromsys" placeholder="请选择">
                                ...
                                <el-option value="物业信息管理平台">物业信息管理平台</el-option>
                                <el-option value="客户主数据中心">客户主数据中心</el-option>
